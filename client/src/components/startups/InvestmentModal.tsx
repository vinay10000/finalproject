          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <div className="relative">
                      <Input {...field} type="number" step="0.1" min={minInvestment} />
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <div className="flex justify-between mb-2 text-sm">
                ...
                <span className="text-gray-900 font-medium">{amount.toFixed(1)} ETH</span>
              </div>
              <div className="flex justify-between mb-2 text-sm">
                <span className="text-gray-500">Transaction Fee</span>
                <span className="text-gray-900 font-medium">~{estimatedFee.toFixed(3)} ETH</span>
              </div>
              <Separator className="my-2" />
              <div className="flex justify-between text-sm font-medium">
                <span className="text-gray-900">Total</span>
                <span className="text-gray-900">~{total.toFixed(3)} ETH</span>
              </div>
            </div>
